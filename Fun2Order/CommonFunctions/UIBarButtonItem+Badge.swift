...
//  Fun2Order
//
//  Created by Lo Fang Chou on 2020/1/7.
...
extension UIBarButtonItem {
    ...
    func addBadge(text: String, withOffset offset: CGPoint = CGPoint(x: -5.0, y: 5.0), andColor color: UIColor = UIColor.red, andFilled filled: Bool = true, andFontSize fontSize: CGFloat = 15)
    {
